...
# Input features for continuous variables
...
# Input features for categorical variables
...
all_feature_names = feature_names_continuous + feature_names_categorical

# Convert feature values into a DataFrame
features_df = pd.DataFrame([feature_values], columns=all_feature_names)
